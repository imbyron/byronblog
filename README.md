...
![Google一下](public/astropaper-og.jpg)

本博客基于 [AstroPaper](https://github.com/satnaing/astro-paper) 主题搭建，AstroPaper 是一个极简、响应式、无障碍且 SEO 友好的 Astro 博客主题。
...
大家可以叫我 Byron，我是一名终身学习者，对认知科学、行为心理学和前沿科技充满热情。通过「Google一下」，我希望记录自己的学习旅程，分享探索过程中的洞见，同时与志同道合的读者建立联系。
...
本博客基于 [AstroPaper](https://github.com/satnaing/astro-paper) 开源模板搭建，感谢原作者的优秀设计与开发。
